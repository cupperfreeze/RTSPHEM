...
if run == 0
    ...
    for i = 1:numTransportVariables
        ...
        RobinData = transport.uR.getdata(stepper.curstep);

        if (isa(transport, 'TransportLEVEL'))
            [ markDirE, neumannCells{i}, markFluxE, markRobinE,markFreeE, ~, idxNeumE, ~,idxRobinE, ~ , markDirT] = ...
                transport.tp_indexsets();
            markNotDirT = ~markDirT;
        else
            [ markDirE, neumannCells{i}, markFluxE, markRobinE, markFreeE, ~, idxNeumE, ~,idxRobinE, ~ ] = ...
                transport.tp_indexsets();
        ...
        [B, C, D, E, bQ, bU, boundaryConditionCells{i}] = ...
            ...
            1, curTau, ...
            dataA, dataAold, dataAvold, dataB, dataBold, dataC, dataD, RobinData, ...
            isDstationary, dataE, dataF, datauD, datagF, markDirE, ...
            neumannCells{i}, markRobinE, markFluxE, idxNeumE, idxRobinE, isSlt);
