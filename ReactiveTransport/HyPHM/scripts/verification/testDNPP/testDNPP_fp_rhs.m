%> @file testDNPP_fp_rhs.m The whole right hand side for the Stokes problem.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%>
...
function ret = testDNPP_fp_rhs(t, x) % k has to be first argument for parallelization
msg = 'HyPHM: RTFM.';
