%> @file testDNPP_c.m Exact concentration distribution for both species @f$c^+@f$ and @f$c^-@f$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%>
...
function ret = testDNPP_c(k, t, x) % k has to be first argument for parallelization
msg = 'HyPHM: RTFM.';
