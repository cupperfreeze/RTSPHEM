%> @file testDNPP_q.m Exact mass fluxes @f$\vec{q}^+@f$ and @f$\vec{q}^-@f$ for both species @f$c^+@f$ and @f$c^-@f$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%>
...
function ret = testDNPP_q(k, t, x) % k has to be first argument for parallelization
msg = 'HyPHM: RTFM.';
