%> @file testSNPP_s.m Source/sink term  @f$s^+@f$ and @f$s^-@f$ for Nernst-Planck problem
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%>
...
function ret = testSNPP_s(k, t, x) % k has to be first argument for parallelization
msg = 'HyPHM: RTFM.';
