%> @file testSNPP_g_c.m Flux boundary data for the Nernst-Planck problem for both species @f$c^+@f$ and @f$c^-@f$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%>
...
function ret = testSNPP_g_c(k, t, x) % k has to be first argument for parallelization
msg = 'HyPHM: RTFM.';
