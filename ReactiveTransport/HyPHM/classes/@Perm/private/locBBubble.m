%> @file classes/@Perm/locB.m Performs the assembly of a local assembly matrix @f$\mathbf{B}_T@f$ under consideration of the global orientation.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%> @retval ret          Local assembly matrix @f$\mathbf{B}_T@f$ [numT x 3 x 4].
%>
